...
Openness is one of our core values, and so we strive to bake it into everything we do—including our [data](./how-it-works/README.md), [code, software](https://github.com/orgs/ourresearch/repositories?language=\&q=openalex\&sort=\&type=public), and [organizational practices](https://ourresearch.org/transparency). This is also why OpenAlex is completely open-source and free to use under the CC0 license.
...
We'd like to thank everyone behind all our [data sources,](./how-it-works/README.md) but especially the folks at [MAG](https://aka.ms/msracad) for building a really audacious and cool thing, and providing us lots of help and support as we build its replacement.
