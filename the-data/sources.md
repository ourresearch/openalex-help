...
Sources are linked to works via the [`works.primary_location`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/works/work-object/README.md#primary\_location) and [`works.locations`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/works/work-object/README.md#locations) properties.
...
The `apc_usd` value is calculated by taking the APC price (see [`apc_prices`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/sources/source-object.md#apc\_prices)) with a currency of USD if it is available. If it's not available, we convert the first available value from `apc_prices` into USD, using recent exchange rates.
...
This will be an [`Institution.id`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/institutions/institution-object.md#id) if the source is a repository, and a [`Publisher.id`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/publishers/publisher-object.md#id) if the source is a journal, conference, or eBook platform (based on the [`type`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/sources/source-object.md#type) field).
...
A list of OpenAlex IDs — See [`Publisher.lineage`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/publishers/publisher-object.md#lineage).

This will only be included if the [`host_organization`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/sources/source-object.md#host\_organization) is a publisher (and not if the `host_organization` is an institution).
...
This is the `display_name` from the [host\_organization](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/sources/source-object.md#host\_organization), shown for convenience.
...
Many publications have multiple [ISSNs](https://en.wikipedia.org/wiki/International\_Standard\_Serial\_Number), so [ISSN-L](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/sources/source-object.md#issn\_l) should be used when possible.
...
| ---------------- | ---------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `journal`        | [Q737498](https://www.wikidata.org/wiki/Q737498)     | The source is an academic journal with an [ISSN](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/sources/source-object.md#issn).                                                         |
| `repository`     | [Q66656823](https://www.wikidata.org/wiki/Q66656823) | The source is a disciplinary or institutional repository.                                                                                                                                                   |
| `conference`     | [Q47258130](https://www.wikidata.org/wiki/Q47258130) | The source publishes Works with [`type`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/works/work-object/README.md#type) "Proceedings", "Proceedings Series" or "Proceedings Article". |
| `ebook platform` | [Q1294318](https://www.wikidata.org/wiki/Q1294318)   | The source publishes Works with [`type`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/works/work-object/README.md#type) containing "book", e.g. "Book Chapter".                       |
...
Each is represented as a [dehydrated Concept](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/concepts/concept-object.md#the-dehydratedconcept-object) object, with one additional attribute:
...
* [`display_name`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/sources/source-object.md#display\_name)
* [`host_organization`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/sources/source-object.md#host\_organization)
* [`host_organization_lineage`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/sources/source-object.md#host\_organization\_lineage)
* [`host_organization_name`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/sources/source-object.md#host\_organization\_name)
* [`id`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/sources/source-object.md#id)
* [`is_in_doaj`](sources.md#is\_in\_doaj)
* [`issn`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/sources/source-object.md#issn)
* [`issn_l`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/sources/source-object.md#issn\_l)
* [`type`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/sources/source-object.md#type)
