...
<figure><object data="../../.gitbook/assets/tmplocations_screenshot_annotate.svg" type="image/svg+xml"></object></figure>
...
[Limited to](https://github.com/ourresearch/openalex-docs/blob/sandbox/authors/limitations.md) the first 100 authors to maintain API performance.

See [`Authorship`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/works/authorship-object.md) for more information.
...
We score open [`Locations`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/works/location-object.md) to determine which is best using these factors:
...
Each item in the is a dehydrated [`Concept` objects](https://github.com/ourresearch/openalex-docs/blob/sandbox/concepts/concept-object.md), with one additional property:
...
This is a list of grant objects, which include the [`Funder`](https://github.com/ourresearch/openalex-docs/blob/sandbox/funders/README.md) and the award ID, if available. Our grants data comes from Crossref, and is currently fairly limited.
...
* `openalex` (_String:_ The [OpenAlex ID](https://github.com/ourresearch/openalex-docs/blob/sandbox/api-entities/how-to-use-the-api/get-single-entities/README.md#the-openalex-id). Same as [`Work.id`](./#id))
...
The work's locations are represented as a list of [`Location`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/works/location-object.md) objects.
