...
In this context "last known" means that we took all the [Works](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/works/work-object/README.md) where this author has an institutional affiliation, sorted them by publication date, and selected the most recent one.

This is a [dehydrated `Institution`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/institutions/institution-object.md#the-dehydratedinstitution-object) object, and you can find more documentation on the [Institution](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/institutions/institution-object.md) page.
...
Each concept is represented as a [dehydrated `Concept`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/concepts/concept-object.md#the-dehydratedconcept-object) object, with one additional attribute:
...
The `DehydratedAuthor` is stripped-down [`Author`](https://github.com/ourresearch/openalex-docs/blob/sandbox/the-data/authors/author-object.md#the-author-object) object, with most of its properties removed to save weight. Its only remaining properties are:
