...
> [!claude]
> Ask Claude: *"Map what [funder] funds by field, how that shifted over the last decade, and the top recipient institutions."* One call profiles the portfolio. Set up once via the [AI agent connector](/access/connector/).
