...
> [!claude]
> You can ask instead: *"Compare how the US and India contribute to SDG 7, and which institutions lead on it."* Set up once: [Using OpenAlex with an AI assistant](/how-to/ai-assistants/).
