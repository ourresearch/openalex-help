...
- **Metadata-dependent matching.** Records without a cleanly reported DOI (or a matchable title and first author) can fail to match. See [Repositories](/data/sources/repositories/) for the metadata guidelines.
