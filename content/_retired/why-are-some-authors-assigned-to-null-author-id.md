...
---
`A9999999999` is the **NULL author** — a single catch-all ID for authorships that didn't go through OpenAlex's disambiguation process. You'll most often see it in the [data snapshot](/access/snapshot/).
...
For the full explanation of how OpenAlex assigns author IDs, see [Author disambiguation](/data/authors/disambiguation/) in the docs.
