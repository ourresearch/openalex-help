...
In between sit [**component**](/data/component/) entities — [authorships](/data/authorships/), [locations](/data/locations/), [raw affiliation strings](/data/raw-affiliation-strings/) — which are parts of a work that don't get their own OpenAlex ID, and [**user-created**](/data/user-created/) entities like [collections](/data/collections/) and [curations](/data/curations/), which users mint rather than OpenAlex.
