...
tags: ["reference"]
---
**Component** entities are structured *parts of a work* that OpenAlex models in detail but doesn't give their own OpenAlex IDs. They aren't full citizens of the [entity galaxy](/data/overview/): a component has no minted ID, and you'll normally meet one *inside* a [work](/data/works/) object, by selecting the field that holds it.
