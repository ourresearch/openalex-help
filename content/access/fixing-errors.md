...
> [!claude]
> If the error is on your own author profile, ask Claude to fix it: *"Make my OpenAlex author profile accurate."* It claims, audits, proposes changes with evidence, and submits the curations. Set up once: [Using OpenAlex with an AI assistant](/how-to/ai-assistants/).
