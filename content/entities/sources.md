...
### `works_api_url`
*String.* A ready-made [Works API](/api/works/) URL that returns every work in this source — i.e. `api.openalex.org/works?filter=primary_location.source.id:S…`. A convenience link, not a filterable field.
