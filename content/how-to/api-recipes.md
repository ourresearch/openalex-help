...
> [!claude]
> Every recipe here is a plain-language ask in Claude, and the answer carries the query it used, ready to paste into the OQL tab or an API URL. Set up once: [Using OpenAlex with an AI assistant](/how-to/ai-assistants/).
