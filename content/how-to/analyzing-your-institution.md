...
> [!claude]
> One question answers most of this page: *"Summarize [my institution]'s 2024 research output: total works, open-access share, share in the top 10% most cited, top fields, and the countries we collaborate with most."* That profile is a single call. Set up once: [Using OpenAlex with an AI assistant](/how-to/ai-assistants/).
