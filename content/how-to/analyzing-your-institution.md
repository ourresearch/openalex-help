...
> [!claude]
> One question answers most of this page: *"Summarize [my institution]'s 2024 research output: total works, open-access share, share in the top 10% most cited, top fields, and the countries we collaborate with most."* That profile is a single call. Set up once via the [AI agent connector](/access/connector/).
