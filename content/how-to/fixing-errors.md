...
> [!claude]
> Own author profile? Ask Claude: *"Make my OpenAlex author profile accurate."* It handles claiming and curating in conversation via the [AI agent connector](/access/connector/). Everything else on this page still goes through a ticket.
