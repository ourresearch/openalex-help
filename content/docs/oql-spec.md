...
- Values are **bare** (no `entity/id` prefix): `I136199984`, `de`, `article`, `13`,
  `gold` — the column carries the namespace (per the [OQO spec](/docs/oqo-schema/)).
...
- **[OQL overview](/docs/oql/)** — the readable tour: every construct with a copyable example.
- **[OQO](/docs/oqo-schema/)** — the canonical query object OQL is sugar over, with its JSON Schema.
