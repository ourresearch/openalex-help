...
- **Paid support.** Organizations that rely on OpenAlex can [subscribe to a plan](/docs/pricing/) that includes guaranteed, timely support.
...
- **AI agents.** This entire site is built to be read by agents ([llms.txt](/llms.txt), a Markdown twin of every page) — asking your agent is often the fastest way to an answer. See [Agents](/docs/agents/).
