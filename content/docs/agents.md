...
**For agents that write queries programmatically**, point them at [OQO](/docs/oqo-schema/) — the JSON query format with a schema to validate against, much harder to get wrong than assembling query strings.
