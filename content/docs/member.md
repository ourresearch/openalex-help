...
---
**Member** is the entry annual plan, at **$5,000/year** — for organizations that rely on OpenAlex and want a bigger API budget, organizational tooling, and a voice in where OpenAlex goes. To buy or ask questions, email [sales@openalex.org](mailto:sales@openalex.org); for prepaid-usage alternatives and purchase mechanics, see [Buying & renewing](/docs/buying-and-renewing/).
...
Member includes community support: post to our public forum and get help from community members. For ticket-based support from our team, see [Member+](/docs/member-plus/) and [Partner](/docs/partner/).
...
Any plan can add the [PDF sync service](/docs/pricing/#the-pdf-sync-add-on) — persistent sync of our full open-access PDF archive to your own storage. Need a bigger budget, daily sync, or real support tickets? [Member+](/docs/member-plus/) includes everything here and more.
