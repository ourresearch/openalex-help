---
title: "Downloading OpenAlex data"
...
## When to use the API vs. downloads
  ...
  - **Use the REST API** — - Quick lookups and searches - Building applications - Real-time data needs - Most use cases
  - **Use data downloads** — - Large-scale analysis - Machine learning training - Building local search indexes - Offline access requirements
...
[Learn more about the snapshot format](/docs/snapshot-data-format/)
...
[OpenAlex CLI documentation](/docs/openalex-cli/)
...
[Full-text PDF documentation](/docs/full-text-pdfs/)
...
1. **For the snapshot:** Follow the [download instructions](/docs/download-to-your-machine/) to get the data to your machine
2. **For the CLI:** Install with `pip install openalex-official` and run `openalex download --help`
3. **For PDFs:** See [full-text PDFs](/docs/full-text-pdfs/) for the three download options
