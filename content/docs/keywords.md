---
title: "Keywords"
description: "Keywords in OpenAlex are short phrases that describe what a work is about. There are over 26,000 keywords in the system, and each work can be tagged with up to 5 of them. Keywor…"
tags: ["data"]
...
---
Keywords in OpenAlex are short phrases that describe what a work is about. There are over 26,000 keywords in the system, and each work can be tagged with up to 5 of them. Keywords are derived from topics — each of the ~4,500 topics has 10 associated keywords.
...
For full details, see the [Keywords API documentation](https://docs.openalex.org/api-entities/keywords).
