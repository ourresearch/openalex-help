...
See [Snapshot data format](/docs/snapshot-data-format/) for the full entity list, the partition structure, and how to keep your copy up to date.
...
For these approaches, the [snapshot data format](/docs/snapshot-data-format/) documentation should have enough detail to get started.
