...
So the two work together: use the builder for the shapes it covers, and drop into the [OQL](/docs/oql/) text when you need the full range. If you want the simpler no-code path instead, go back to [basic](/docs/web-interface-basic/).
