...
Check whether we already harvest you, and if not, send a support request — the steps are on [Getting indexed](/help/getting-indexed/#how-do-i-get-my-repository-indexed-in-openalex).
