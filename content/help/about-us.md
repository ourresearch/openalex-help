---
title: "About us"
description: "Inspired by the Library of Alexandria, we catalog 474 million scholarly works, linking them to authors, institutions, funders, and more—all fully open."
tags: ["hello"]
source_id: "24396686889751"
source_url: "https://help.openalex.org/hc/en-us/articles/24396686889751-About-us"
...
OpenAlex has a multi-year track record of building sustainable scholarly infrastructure, and a formal commitment to sustainability through our adoption of the [Principles of Open Scholarly Infrastructure (POSI)](https://openscholarlyinfrastructure.org/). You can read our most recent [POSI self-assessment](https://blog.openalex.org/recommitting-to-the-principles-of-open-scholarly-infrastructure-posi/) on the OpenAlex blog.

The core OpenAlex data will always be free. The full dataset—hundreds of millions of works and all associated metadata—is free to download, share, remix, and build on under a CC0 license, with quarterly public snapshots. To keep that open infrastructure healthy and growing, we charge for _services_ built on top of the data, in line with the POSI principle of revenue based on services, not data.
...
Learn more about both on our [pricing page](https://openalex.org/pricing).
