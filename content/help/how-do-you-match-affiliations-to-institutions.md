...
canonical: /entities/institutions/#how-we-build-it
---
The affiliation printed on a paper is free text — "Dept. of Physics, Univ. of Washington, Seattle" — so OpenAlex has to figure out which real organization it names. It keeps that exact text as a [raw affiliation string](/entities/raw-affiliation-strings/) and runs it through a matcher that maps it to one or more [institutions](/entities/institutions/), each identified by a [ROR](https://ror.org/) ID.
...
For the full pipeline and its known limitations, see [how we build institutions](/entities/institutions/#how-we-build-it).
