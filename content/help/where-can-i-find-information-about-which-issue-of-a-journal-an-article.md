...
---
You can find issue-level metadata for an article either by exporting search results from the user interface or in the ["biblio" field](/data/works/#biblio) in the response to an API call for a specific work. For instance: 
