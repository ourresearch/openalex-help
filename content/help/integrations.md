...
---
OpenAlex data flows into a lot of other tools. This page covers exporting from the website and the most common third-party integrations. For programmatic access, see [Get the data](/docs/get-the-data/).
