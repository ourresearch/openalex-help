...
canonical: /data/works/#field-weighted-citation-impact
---
...
For the exact formula, the citation window, and how OpenAlex's FWCI compares to other databases', see [FWCI on the works page](/data/works/#field-weighted-citation-impact).
