...
* Get the works whose [type](broken-reference) is `book`:\
...
* [Works](filter-works.md)
* [Authors](filter-authors.md)
* [sources](filter-sources.md)
* [Institutions](filter-institutions.md)
* [Concepts](filter-concepts.md)
